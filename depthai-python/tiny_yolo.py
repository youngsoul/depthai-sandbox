...
"""
From:
https://github.com/luxonis/depthai-python/blob/main/examples/Yolo/tiny_yolo.py
"""
...
blobconverter_cache_dir = '/Users/patrickryan/.cache/blobconverter'
v3 = "yolo-v3-tiny-tf_openvino_2021.4_6shave.blob"
v4 = "yolo-v4-tiny-tf_openvino_2021.4_6shave.blob"

# Get argument first
nnPath = str((Path(blobconverter_cache_dir) / v4 ).resolve().absolute())
if 1 < len(sys.argv):
    arg = sys.argv[1]
    if arg == "yolo3":
        nnPath = str((Path(blobconverter_cache_dir) / v3).resolve().absolute())
    elif arg == "yolo4":
        nnPath = str((Path(blobconverter_cache_dir) / v4).resolve().absolute())
    else:
        nnPath = arg
